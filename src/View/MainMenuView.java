...
public class MainMenuView extends JPanel {
    ...
    private void setUnivNamePanel() {
        ...
        lblUnivName.setFont(new Font(DesignConstants.ENGLISH_FORMAL_FONT, Font.BOLD, 20));
    ...
    public void setUser(UserDTO user)
    {
        ...
        ClassManager.getInstance().getTimetableView();
        ClassManager.getInstance().getLectureListView(new org.json.simple.JSONObject());

        if (user != null) {
            ArrayList<LectureDTO> myLectures = ClassManager.getInstance().getDAO().getMyLecture(user);
        }
