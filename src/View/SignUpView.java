...
public class SignUpView extends JPanel{
    ...
    private void setSignUpPanel() {
        ...
        signUpBtn.setBounds(idTextField.getX(), phone.getY() + phone.getHeight() + margin * 4,
   ...
   // }
    ...
    public UserDTO getInsertData(){
        ...
        if(idTextField.getText() == null || pwTextField.getText() == null || nameTextField.getText() == null || phoneTextField.getText() == null)
            return null;
